...
import os
import shutil
from typing import Iterable, Mapping, Optional, Sequence, Text
...
class QMC:
  ...
  def train(self,
    ...
    with tf.train.MonitoredTrainingSession(
      ...
      with Writer(name='train_stats', schema=train_schema, directory=logging_config.result_path) as training_writer, \
          H5Writer(name='data.h5', schema=h5_schema, directory=logging_config.result_path) as h5_writer:
